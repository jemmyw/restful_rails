      ...
      def self.included(base)
        ...
        protected
          ...
          unless instance_methods.include?('find_resource')
            ...
            def find_resource(id = params[:id])
              resource_service.find(id) rescue nil
            end
          end
          ...
          unless instance_methods.include?('after_create')
          ...
          unless instance_methods.include?('after_update')
          ...
          unless instance_methods.include?('after_destroy')
            def after_destroy(success)
